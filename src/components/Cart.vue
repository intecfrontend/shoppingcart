<template>
  <div >
    ...
    <b-row>
      ...
      <div class="selectdiv bg-primary" variant="primary"> <div class="selectdiv2"><h2 class="selecth2">The Shop</h2></div>
      <select v-model="selectedCategory" v-on:change="categoryChange()">
